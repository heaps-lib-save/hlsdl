...
#if	defined(HL_IOS) || defined(HL_TVOS)
	// SDL3 on iOS uses Metal by default. For OpenGL ES, the default framebuffer
	// is managed by SDL internally. Binding framebuffer 0 will bind the
	// SDL-managed default framebuffer.
	// The old SDL_SysWMinfo approach is removed in SDL3.
#endif
...
#if	defined(HL_IOS) || defined(HL_TVOS)
	// SDL3 on iOS uses Metal by default. For OpenGL ES, the default renderbuffer
	// is managed by SDL internally. Binding renderbuffer 0 will bind the
	// SDL-managed default renderbuffer.
	// The old SDL_SysWMinfo approach is removed in SDL3.
#endif
