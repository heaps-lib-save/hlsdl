...
class Sdl {
	...
	public static var requiredGLMajor(default,null) = 4;
	public static var requiredGLMinor(default,null) = 6;
	...
	public static function setGLOptions( major : Int = 4, minor : Int = 6, depth : Int = 24, stencil : Int = 8, flags : Int = 1, samples : Int = 1 ) {
	...
	public static function getDevices() {
		...
		for( v in arr ) {
			if( v == null ) break;
			var d = StringTools.trim(@:privateAccess String.fromUCS2(cast v));
	...
	public static function setRelativeMouseMode( enable : Bool ) : Bool {
		return false;
	}
	...
	public static function setClipboardText( text : String ) : Bool {
		if( text == null )
			return false;
		@:privateAccess _setClipboardText( text.toUtf8() );
		return true;
	}
	...
	static function get_devices() : hl.NativeArray<Dynamic> {
		return null;
	}
	...
	@:hlNative("sdl", "warp_mouse_global")
	public static function warpMouseGlobal( x : Int, y : Int ) : Bool {
		return false;
	}
	...
	@:hlNative("sdl", "detect_keyboard_layout")
